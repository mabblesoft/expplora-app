			...
			<View
				...
				<TouchableOpacity
					style={{
						...
						width: '48%',
						backgroundColor:
							category == 'upcoming' ? COLORS.green : COLORS.lightGreen,
					...
					<Text
						style={{
							...FONTS.Poppins_Bold,
							fontSize: 16,
							color: category == 'upcoming' ? COLORS.white : COLORS.green,
						}}>
						Upcoming
					</Text>
				</TouchableOpacity>
				<TouchableOpacity
					style={{
						...
						width: '48%',
						backgroundColor:
							category == 'history' ? COLORS.yellow : COLORS.lightYellow,
						justifyContent: 'center',
						alignItems: 'center',
						borderRadius: 10,
					}}
					...
					<Text
						style={{
							...FONTS.Poppins_Bold,
							fontSize: 16,
							color: category == 'history' ? COLORS.white : COLORS.yellow,
						}}>
						History
					</Text>
				</TouchableOpacity>
