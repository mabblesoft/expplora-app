...
import backgroundUrl from '../../images/background/bg1.jpeg';

const db = DatabaseConnection.getConnection();

const image = { uri: backgroundUrl };
			...
			<View style={{ flex: 1, backgroundColor: 'white' }}>
				<View style={{ flex: 1 }}>
					<View
						...
						className='view view-main view-init safe-areas'>
						<View style={styles.loaderScreen} style={styles.image}>
							<View>
								<View>
									<View style={styles.loadIcon}></View>
									<Mytext style={styles.loadText}>
										<Mytext>K</Mytext>
										<Mytext>O</Mytext>
										<Mytext>F</Mytext>
										<Mytext>E</Mytext>
...
<View className='page'>
    <View className='page-content'>
        <View className='sidebar-menu'>
            <View className='main-logo left'>
                ...
                <View className='logo-content'>
                    <Mytext className='logo-name'>kofee</Mytext>
                </View>
            </View>
        ...
        <View className='sidebar-footer'>
            <h5 className='name'>kofee Coffee App</h5>
...
<View
    ...
    className='row no-gutters vh-100 overlay-primary-dark loader-screen'
    v-bind:style='{ backgroundImage: `url(${backgroundUrl})` }'>
    <View className='col align-self-center text-white text-align-center'>
        <View id='loading-area'>
            <View className='logo-icon'>
                <svg
                    width='80'
                    height='92'
...
<View className='page page-onboading' data-name='home'>
    <View className='page-content'>
        <View className='started-swiper-box'>
            <View
...
'>
                <View className='swiper-wrapper'>
                    <View className='swiper-slide'>
                        <View className='slide-info'>
                            <View className='dz-media'>
                                <Image
                                    source={require('../img/svg/illustration.svg')}
                                />
                            </View>
                            <View className='slide-content'>
                                <Mytext className='dz-title'>
                    ...
                    <View className='swiper-slide'>
                        <View className='slide-info'>
                            <View className='dz-media'>
                                <Image src='../img/svg/coffee-mug.svg' />
                            </View>
                            <View className='slide-content'>
                                <Mytext className='dz-title'>
                    ...
                    <View className='swiper-slide'>
                        <View className='slide-info'>
                            <View className='dz-media'>
                                <Image src='../img/svg/coffee-cup.svg' />
                            </View>
                            <View className='slide-content'>
                                <Mytext className='dz-title'>
                ...
                <View className='swiper-pagination'></View>
            </View>
        </View>
    </View>
    <View className='toolbar toolbar-bottom container footer-button'>
        <Mybutton
            className='button-large rounded-xl button button-fill'
            title='Get started'
        />
    </View>
</View>
